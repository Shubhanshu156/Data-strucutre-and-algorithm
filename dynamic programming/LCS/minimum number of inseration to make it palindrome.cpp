...
#include<String>
using namespace std;
//TAKE A STRING "zabcba" in this minimum number of deltation are 1 same as number of inseration
//TAKE A STRING "zyabcba" in this minimum number of deltation are 2(abcba) same as number of inseration(zyabcbayz)
